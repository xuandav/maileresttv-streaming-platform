                ...
                <?php if ($success): ?>
                    <div class="success-message">
                        ...
                        <div class="success-actions">
                            <a href="../public/live.php?channel_id=<?php echo $channelId; ?>" target="_blank" class="btn-secondary">Ver Canal</a>
                    ...
                    <div class="channel-preview">
                        ...
                        <div class="preview-card">
                            ...
                            <div class="preview-actions">
                                <a href="../public/live.php?channel_id=<?php echo $channelId; ?>" target="_blank" class="btn-view">
                                    Ver Canal
                                </a>
                            </div>
                        </div>
